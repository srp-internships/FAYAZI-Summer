namespace VidzyExercise.Migrations
{
    ...
    public partial class ChangedRelationshipInTableVideos : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("UPDATE dbo.Videos SET Genre_Id = (SELECT TOP 1 Genre_Id FROM dbo.VideoGenres WHERE Video_Id = dbo.Videos.Id)");
